...
class Arch2lTidigits(Network):

    def __init__(
            self,

            l1_type_neuron: type[Neuron] = NeuronStochastic,
            ...
            pd_networks: str = Network.PD_NETWORKS + "arch2l-tidigits/",
            ndt_network: str = "arch2l-tidigits{:04d}/", # _{idx_network}
        ...
        self.l2_hz = Network.HZ_TIMESTEP / self.n_timebins_max
        # ---------------------------------------------------------------------
    ...
    @classmethod
    def run_speaker(cls, device='cpu', seed=2023):
        """ 
        Create and run a network on all single-digit utterances. 
        """

        # Number of unique train stimuli
        N_UNIQUE_TRAIN = 22
        ...
        L2_IDLE_UNTIL = N_UNIQUE_TRAIN*2

        # Create the network
        network = cls._create(
            l1_type_neuron=NeuronStochastic,

            en_variable_duration=True,
            ...
            l1_K=(30,),
            l1_hz=162.5,
            l1_n_max_simultaneous_spikes=3,
            l1_cst_idle=2,
    ...
    def run_all_default(cls, device='cpu', seed=2023):
        ...
        # After how many stimuli layer-2 becomes active
        L2_IDLE_UNTIL = N_UNIQUE_TRAIN*3
    ...
    def run_all_custom(cls):
        ...
        # After how many stimuli layer-2 becomes active
        L2_IDLE_UNTIL = N_UNIQUE_TRAIN*5
        ...
        network = cls._create(
            ...
            note="Based on baseline sc4-22.",
            note2="100 hz layer 1",
            )
